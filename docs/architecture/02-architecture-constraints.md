...
|------------|-----------|
| **Python 3.11 or newer.** | Matches the Python version available in the maintainer's environment and on common Linux distributions. The lower bound is also what CI tests (3.11 + 3.12 in `.github/workflows/ci.yml`). |
