...
- `test_solve_deterministic_best_partial_under_max_restarts` — a
  `max_restarts`-bounded canary (`test_solve_deterministic_polygon_taper_fleet`, `:279`, is a
  second, also `max_restarts`-bounded and same-machine), the mode the contract promises is cross-machine —
...
- Reeds–Shepp base solvers (`_rs_lsl…_rs_lrslr` in `_RS_BASE_SOLVERS`, `:692-812`): `math.sin/cos`, `math.atan2` (e.g. `:706`, `:754`, `:783`, `:798`), `math.acos` (`:730`, `:742`), `math.sqrt`.
- Dubins word solvers (`_lsl…_lrl`, `:326-383`; feed `plan_dubins`): `math.sin/cos` (`:327` etc.), `math.atan2` (`:331`, `:340`, `:350`, `:360`, `:370`, `:381`), `math.sqrt` (`:332`, `:341`, `:349`, `:359`), `math.acos` (`:369`, `:380`).
