...
- Related ADRs: [ADR-0003](0003-rr-mc-solver-algorithm.md) (the byte-identical contract whose scope this amends); [ADR-0028](0028-learned-backend-train-to-mastery-resolved-negative.md) (the *train-to-mastery* outcome — resolved-negative, scoped to this seam — a separate decision that leaves this determinism contract untouched).
